...
#train_df_with _dummies_noNaN.head(3)
...
#y_classf.head(3)
# create features
X_classf = train_df_with_dummies_noNaN.drop(['Marital_Status'], axis=1).values# values字典
X_classf.shape
X_classf.head(3)
...
joblib.dump(RF_classifier, './model/RandomForestClassifier.pkl')
